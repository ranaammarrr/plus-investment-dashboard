...
const routes: CustomRoute[] = [
  ...
  },
  {
    ...
    element: lazy(()=> import('../Screens/Dashboard/PropertyDetails/PropertyDetails')),
    isPrivate: true, 
  ...
  {
    path: "/transactions",
    element: lazy(()=> import('../Screens/Dashboard/Transaction/Transactions')),
    isPrivate: true, 
    name: 'Transactions'
    ...
    {
    path: "/counter-offers",
    element: lazy(()=> import('../Screens/Dashboard/CounterOffers/CounterOffers')),
    isPrivate: true, 
    name: 'Counter-Offers'
  ...
  {
    path: "/pages/terms",
    element: lazy(()=> import('../Screens/Dashboard/Pages/TermsAndConditions')),
    isPrivate: true, 
  ...
  },
  {
    ...
    element: lazy(()=> import('../Screens/Dashboard/PropertyListing/AddProperty')),
    isPrivate: true, 
    name: 'Add Property'
  ...
  {
    path: "/propertyType",
    element: lazy(()=> import('../Screens/Dashboard/PropertyListing/PropertyType')),
    isPrivate: true,
    name: 'Property Type'
  },
  {
    path: "/view-counter-offer",
    element: lazy(()=> import('../Screens/Dashboard/CounterOffers/DetailedCounterOffer')),
    isPrivate: true,
    name: ''
  },
  {
    path: "/viewTransactions",
    element: lazy(()=> import('../Screens/Dashboard/Transaction/ViewTransactions')),
    isPrivate: true,
    name: 'All Transactions'
  },
  {
    path: "/counterOffer",
    element: lazy(()=> import('../Screens/Dashboard/Transaction/CounterOffer')),
    isPrivate: true,
    name: 'All Transactions'
  },
  {
  ...
  {
    path: "/insights",
    element: lazy(()=> import('../Screens/Dashboard/Timeline/TimelineInsights')),
    isPrivate: true,
