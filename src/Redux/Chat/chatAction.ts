...
export const getAllChatList = createAsyncThunk<Chat, string, { rejectValue: ApiError }>(
  'properties/getPropertyDetail',
  async (chat_Id, { rejectWithValue }) => {
      try {
        const response = await fetch(`${BASE_URL}${ENDPOINTS.GET_CHAT_LIST}/${chat_Id}`, {
          method: 'GET',
          headers: {
        ...
        // console.log(apiResponse.data.chats,"responseeeee")
  ...
  export const getChatIdByUsers = createAsyncThunk<Chat, any, { rejectValue: ApiError }>(
    'chat/getChatIdByUsers',
    async (data, { rejectWithValue }) => {
      try {
        const response = await fetch(`${BASE_URL}${ENDPOINTS.GET_CHAT_BY_ID_USERS}/${data?._id}/${data?.senderId}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`, 
  ...
  export const getAllChats = createAsyncThunk<Chat, void, { rejectValue: ApiError }>(
    'properties/getPropertyDetail',
